...
var $author$project$Main$cancelEditing = function (editable) {
	if (editable.$ === 'Editing') {
		...
		var buffer = editable.a.buffer;
		return $author$project$Main$NotEditing(originalValue);
	} else {
		return editable;
	}
};
var $author$project$Main$cancelEditingDescription = function (task) {
	return _Utils_update(
		task,
		{
			description: $author$project$Main$cancelEditing(task.description)
		});
};
var $author$project$Main$cancelEditingName = function (task) {
	return _Utils_update(
		task,
		{
			name: $author$project$Main$cancelEditing(task.name)
		});
};
...
var $author$project$Main$editTaskForId = F3(
	function (id, editFunction, tasks) {
		var editTaskIfId = function (task) {
			return _Utils_eq(id, task.id) ? editFunction(task) : task;
		};
...
var $author$project$Main$setCommentBuffer = F2(
	function (newComment, task) {
		return _Utils_update(
			task,
			{
				comments: {buffer: newComment, savedComments: task.comments.savedComments}
			});
	});
var $author$project$Main$Editing = function (a) {
	return {$: 'Editing', a: a};
};
var $author$project$Main$updateBuffer = F2(
	function (value, temp) {
		if (value.$ === 'Editing') {
			var originalValue = value.a.originalValue;
			return $author$project$Main$Editing(
				{buffer: temp, originalValue: originalValue});
		} else {
			return value;
		}
	});
var $author$project$Main$setDescriptionBuffer = F2(
	function (newDescription, task) {
		return _Utils_update(
			task,
			{
				description: A2($author$project$Main$updateBuffer, task.description, newDescription)
			});
	});
var $author$project$Main$setNameBuffer = F2(
	function (newBuffer, task) {
		return _Utils_update(
			task,
			{
				name: A2($author$project$Main$updateBuffer, task.name, newBuffer)
			});
	});
var $author$project$Main$startEditing = function (editable) {
	if (editable.$ === 'Editing') {
		return editable;
	} else {
		var value = editable.a;
		return $author$project$Main$Editing(
...
var $author$project$Main$startEditingDescription = function (task) {
	return _Utils_update(
		task,
		{
			description: $author$project$Main$startEditing(task.description)
		});
};
var $author$project$Main$startEditingName = function (task) {
	return _Utils_update(
		task,
		{
			name: $author$project$Main$startEditing(task.name)
		});
};
var $author$project$Main$stopEditing = function (value) {
	if (value.$ === 'Editing') {
		var buffer = value.a.buffer;
		return $author$project$Main$NotEditing(buffer);
	} else {
		return value;
	}
};
var $author$project$Main$stopEditingDescription = function (task) {
	return _Utils_update(
		task,
		{
			description: $author$project$Main$stopEditing(task.description)
		});
};
var $author$project$Main$stopEditingName = function (task) {
	return _Utils_update(
		task,
		{
...
var $author$project$Main$toggleStatus = function (task) {
	...
	if (_v0.$ === 'Complete') {
		...
		return _Utils_update(
			task,
			{status: $author$project$Main$Complete});
	}
};
var $author$project$Main$Expanded = {$: 'Expanded'};
var $author$project$Main$toggleTaskViewState = F2(
	function (id, tasks) {
		var toggleViewState = function (task) {
			...
			if (_v0.$ === 'Expanded') {
				...
				return _Utils_update(
					task,
					{viewState: $author$project$Main$Expanded});
			}
		};
		return A3($author$project$Main$editTaskForId, id, toggleViewState, tasks);
	});
...
var $author$project$Main$UserClickedSaveEditTaskDescription = function (a) {
	return {$: 'UserClickedSaveEditTaskDescription', a: a};
};
var $author$project$Main$UserEditedTaskDescription = F2(
	function (a, b) {
	...
	if (_v0.$ === 'Editing') {
				...
				[
					...
					_List_fromArray(
						[
							...
							function (description) {
								return A2(
									$author$project$Main$UserEditedTaskDescription,
									task.id,
									$author$project$Main$TaskDescription(description));
							}),
							$elm$html$Html$Attributes$value(
							$author$project$Main$descriptionValue(buffer))
						]),
					_List_Nil),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedSaveEditTaskDescription(task.id))
						]),
					_List_fromArray(
						[
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Main$descriptionValue(taskDescription)),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedEditTaskDescription(task.id))
						]),
					_List_fromArray(
						[
...
var $author$project$Main$UserClickedCancelEditTaskName = function (a) {
	return {$: 'UserClickedCancelEditTaskName', a: a};
};
var $author$project$Main$UserClickedEditTaskName = function (a) {
	return {$: 'UserClickedEditTaskName', a: a};
};
var $author$project$Main$UserClickedSaveEditTaskName = function (a) {
	return {$: 'UserClickedSaveEditTaskName', a: a};
};
var $author$project$Main$UserClickedToggleTaskViewState = function (a) {
	return {$: 'UserClickedToggleTaskViewState', a: a};
};
var $author$project$Main$UserEditedTaskName = F2(
	function (a, b) {
				...
				[
					...
					_List_fromArray(
						[
							...
							function (name) {
								return A2(
									$author$project$Main$UserEditedTaskName,
									task.id,
									$author$project$Main$TaskName(name));
							}),
							$elm$html$Html$Attributes$value(
							$author$project$Main$nameValue(buffer))
						]),
					_List_Nil),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedSaveEditTaskName(task.id))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('save')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedCancelEditTaskName(task.id))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('cancel')
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedToggleTaskViewState(task.id))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Main$nameValue(taskName))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$UserClickedEditTaskName(task.id))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('edit')
...
var $author$project$Main$taskView = function (task) {
	var updateStatusButtonView = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('toggle complete')
			]));
	var deleteButtonView = A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
...
var $author$project$Main$completeTasksView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$UserClickedAddTask = {$: 'UserClickedAddTask'};
var $author$project$Main$UserEditedNewTaskDescription = function (a) {
	return {$: 'UserEditedNewTaskDescription', a: a};
};
var $author$project$Main$UserEditedNewTaskName = function (a) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(
						$author$project$Main$descriptionValue(model.newTaskDescription)),
						$elm$html$Html$Events$onInput(
						function (taskName) {
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$string)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UserClickedAddTask":[],"UserEditedNewTaskName":["Main.TaskName"],"UserEditedNewTaskDescription":["Main.TaskDescription"],"UserClickedDeleteTask":["Main.Id"],"UserClickedToggleTaskViewState":["Main.Id"],"UserClickedEditTaskName":["Main.Id"],"UserClickedSaveEditTaskName":["Main.Id"],"UserClickedCancelEditTaskName":["Main.Id"],"UserEditedTaskName":["Main.Id","Main.TaskName"],"UserClickedEditTaskDescription":["Main.Id"],"UserClickedSaveEditTaskDescription":["Main.Id"],"UserClickedCancelEditTaskDescription":["Main.Id"],"UserEditedTaskDescription":["Main.Id","Main.TaskDescription"],"UserClickedUpdateStatus":["Main.Id"],"UserEditedTaskComment":["Main.Id","Main.TaskComment"],"UserClickedAddComment":["Main.Id"],"Tick":["Time.Posix"],"AdjustTimeZone":["Time.Zone"]}},"Main.Id":{"args":[],"tags":{"Id":["Basics.Int"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Main.TaskComment":{"args":[],"tags":{"TaskComment":["String.String"]}},"Main.TaskDescription":{"args":[],"tags":{"TaskDescription":["String.String"]}},"Main.TaskName":{"args":[],"tags":{"TaskName":["String.String"]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));